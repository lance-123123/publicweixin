...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" /> 
   ...
   <link rel="shortcut icon" type="image/x-icon" href="/Lanceblogv.1/Public/Admin/image/ad.ico" />
	...
	<link rel="stylesheet" type="text/css" href="/Lanceblogv.1/Public/Admin/css/User/personal.css">
...
<body>   
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.html">  lance blog </a>
           <input type="hidden" url="/Lanceblogv.1/index.php/Admin/User" id="jump" >
        </div>
 ...
 <div style="margin-left:18%;">
	 <div class="row" style="width:100%">
		  <!-- 导航列表 -->
		  <div class="col-lg-12" >
		    <h1>Lance Blog <small>个人中心</small></h1>
		    <ol class="breadcrumb" >
		      <li class="active"><i class="fa fa-dashboard"></i>个人中心</li>
		    </ol>
		  </div>

          <!-- 个人中心 -->
           <div class="bodyset" style="position: relative;">

               <div class="leftset" style="position: absolute;">
                   <div><a href="#"><img src="/Lanceblogv.1/Public/Admin/image/image.jpg" height="150px" width="150px"></a>
                   </div>
                   <div class="managerset">
                       <span><a href="#" id="eduit">编辑</a> | <a href="#">查看</a></span>
                   </div>
               </div>
               
               <div class="rightset" style="position: absolute;">
                  <form action="/Lanceblogv.1/index.php/Admin/User/modify_user_detail" method="post" id="form">
                    <div class="form-group">
                        <label>昵&nbsp;&nbsp;&nbsp;称: </label>
                        <p class="user_detail"><?php echo ($data["nicname"]); ?></p>
                        <input class="form-control" name="nicname" id="name" value="<?php echo ($data["nicname"]); ?>">
                    </div>

                    <div class="form-group">
                        <label>家&nbsp;&nbsp;&nbsp;乡: </label>
                        <p class="user_detail"><?php echo ($data["hometown"]); ?></p>
                        <input class="form-control" name="hometown" id="home" value="<?php echo ($data["hometown"]); ?>">
                    </div>

                    <div class="form-group">
                        <label>现居地:</label>
                        <p class="user_detail"><?php echo ($data["nowhome"]); ?></p>
                        <input class="form-control" name="nowhome" id="nowlive" value="<?php echo ($data["nowhome"]); ?>">
                    </div>

                    <div class="form-group">
                        <label>兴&nbsp;&nbsp;&nbsp;趣: </label>
                        <p class="user_detail"><?php echo ($data["intreastthing"]); ?></p>
                        <input class="form-control" name="intreastthing" id="intrest" value="<?php echo ($data["intreastthing"]); ?>">
                    </div>

                    <div class="form-group">
                        <label>座右铭:</label>
                        <p class="user_detail"><?php echo ($data["lovemotto"]); ?></p>
                        <textarea class="form-control" id="motto" name="lovemotto" rows="3" ><?php echo ($data["lovemotto"]); ?></textarea>
                    </div>

                    <div class="form-group">
                        <label>简&nbsp;&nbsp;&nbsp;介:</label>
                        <p class="user_detail"><?php echo ($data["selfintroduction"]); ?></p>
                        <textarea class="form-control" id="introduction" name="selfintroduction" rows="3"><?php echo ($data["selfintroduction"]); ?></textarea>
                    </div>

                    <button type="submit" class="btn btn-success" style="margin-right:30%">确定</button>
 ...
 <!-- JavaScript -->
    ...
    <script type="text/javascript" src="/Lanceblogv.1/Public/Admin/js/user/persional.js"></script>
    <!-- 左侧导航高亮 -->
    <script type="text/javascript">
        $(function() {
